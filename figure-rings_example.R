...
# Generate Data (Average Counterfactual Trends Only) ---------------------------
...
plot(first_diff$dist, first_diff$d_y0)
...
ggsave(
  here::here("figures/figure-rings_example_average_pt.pdf"), plot,
  width = 8, height = 8 * 9 / 16, dpi = 300
)
ggsave(
  here::here("figures/figure-within_example_average_pt.pdf"), plot_within,
  width = 8, height = 8 * 9 / 16, dpi = 300
)
...
ggsave(
  here::here("figures/figure-rings_v_within_average_pt.pdf"), plot_both,
  width = 8, height = 8 * 9 / 16, dpi = 300
)
